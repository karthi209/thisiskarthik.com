...
Not the big dramatic life choices... but the ones like choosing an operating system.

I say this because I spent an unreasonable amount of time deciding between operating systems that, on paper, all do the same thing. In reality, though, they follow very different philosophies. At some point, it even feels like you’re picking a religion.

Windows was my first operating system. More specifically, it was Windows 2000. My memories of it are fuzzy but I remember it having Paint, Clippy and a bunch of freeware games that literally made my childhood. Icy Tower, Brainsbreaker and few other games that I had no idea how it ended up in my computer but I probably spent more time in it than any modern game I bought willingly with my own money.
...
Linux has technically been part of my life for years. I’ve dual-booted it for the past five years. It lived in a forgotten 100 GB partition that I almost never touched. My first serious attempt to use Linux as a daily driver was in 2019. I installed vanilla Debian. With GNOME. On a laptop.

This was not a good idea.

The scaling... the trackpad... uh. Everything worked, but nothing felt good to use. Going back to Windows 10 afterwards felt like returning to something polished and expensive. From that point on, Linux became my place for experiments, not actual work.

Until 2026.

This time, I did proper research and locked down on Kubuntu, which is the KDE version of Ubuntu. I wanted something that mostly worked out of the box. I knew KDE handled fractional scaling better, so that narrowed things down quickly. I looked at KDE Neon, Debian with KDE Plasma, and a few others. But Kubuntu immediately felt right.
